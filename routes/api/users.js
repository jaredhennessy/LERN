...
// Matches with "/api/users", returns all registered users in database (currently array)
router.route("/")
  .get(usersController.findAll)

// Matches with "/api/users/:id", authenticates for valid token, then returns courses with token user
router.route("/:id")
  .get(authenticateToken, usersController.findUserCourses)

// Matches with "/api/users/create", creates a username with hashed password in database (currently array)
