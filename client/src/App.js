        ...
        <div className="App">
          <ThemeProvider theme={createMuiTheme}>
            ...
            <Switch>
              ...
              <Route
                exact
                path="/createCourseDisclaimer"
                component={CreateCourseDisclaimer}
              />
              ...
              <Route
                exact
                path="/users/:id"
                render={() => (userData.user ? <Dashboard /> : <Login />)}
              />
              <Route
                exact
                path="/teach/:id"
                render={() => (userData.user ? <Teach /> : <Login />)}
              />
              <Route
                exact
                path="/teach"
              ...
              <Route
                exact
                path="/pages/c/:course/p/:page"
                render={() => (userData.user ? <LERN /> : <Login />)}
              />
              <Route
                exact
                path="/pages/c/:course/complete"
                render={() => (userData.user ? <CompleteCourse /> : <Login />)}
              />
            </Switch>
            <FooterAlt />
          </ThemeProvider>
